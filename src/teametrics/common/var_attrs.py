...
def get_attrs(vname=None, dec=False, spread=None, period='', data_unit=''):
    ...
    attrs = {
        ...
        'TEX_max_interval': {'long_name': 'interval of maximum event extremity',
                             'units': 'date', 'metric_type': 'basic'},
        'TEX_HW_max': {'long_name': 'maximum heatwave extremity',
                   'units': f'100 km^2 {data_unit}', 'metric_type': 'basic'},
        'TEX_HW_max_interval': {'long_name': 'interval of maximum heatwave extremity',
                                'units': 'date', 'metric_type': 'basic'},
