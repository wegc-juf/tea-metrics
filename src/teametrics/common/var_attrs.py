...
def get_attrs(vname=None, dec=False, spread=None, period='', data_unit=''):
    ...
    attrs = {
        ...
        'DTEP': {'long_name': 'daily threshold exceedance population', 'units': '10^4 person'},
        'DTEMA': {'long_name': 'daily threshold exceedance magnitude * area (auxiliary)',
                  'units': f'100 km^2 {data_unit}'},
        'DTEMP': {'long_name': 'daily threshold exceedance magnitude * population (auxiliary)',
                  'units': f'10^4 person {data_unit}'},
        ...
        'AEP': {'long_name': 'annual exposure period', 'units': 'months',
                'metric_type': 'basic'},
        'ED': {'long_name': 'cumulative events duration', 'units': f'd',
               'metric_type': 'compound'},
        'ED_avg': {'long_name': 'average events duration', 'units': 'd',
                   'metric_type': 'basic'},
        'EM': {'long_name': 'cumulative exceedance magnitude', 'units': f'{data_unit} d',
        ...
        'EM_Md': {'long_name': 'cumulative daily-median exceedance magnitude',
                  'units': f'{data_unit} d', 'metric_type': 'compound'},
        ...
        'TEX': {'long_name': 'total events extremity',
                'units': f'100 km^2 {data_unit} d', 'metric_type':
                    'compound'},
        'pTEX': {'long_name': 'total events population-extremity',
                 'units': f'10^4 person {data_unit} d', 'metric_type':
                     'compound'},
        'TEX_max': {'long_name': 'maximum event extremity',
                    'units': f'100 km^2 {data_unit} d', 'metric_type': 'basic'},
        'TEX_max_interval_start': {
            'long_name': 'start timestamp of maximum event extremity interval',
            'metric_type': 'metadata'},
        'TEX_max_interval_end': {
            'long_name': 'end timestamp of maximum event extremity interval',
            'metric_type': 'metadata'},
        'TEX_HW_max': {'long_name': 'maximum heatwave extremity',
                   'units': f'100 km^2 {data_unit} d', 'metric_type': 'basic'},
        'TEX_HW_max_interval_start': {
            'long_name': 'start timestamp of maximum heatwave extremity interval',
            'metric_type': 'metadata'},
        'TEX_HW_max_interval_end': {
            'long_name': 'end timestamp of maximum heatwave extremity interval',
            'metric_type': 'metadata'},
        ...
        'hES_avg': {'long_name': 'average hourly event severity',
                    'units': f'100 km^2 {data_unit} h', 'metric_type': 'compound'},
        'tEX': {'long_name': 'temporal events extremity', 'units': f'{data_unit} d',

                'metric_type':
                    'compound'},
        'htEX': {'long_name': 'hourly temporal events extremity',
                 'units': f'{data_unit} h', 'metric_type':
                     'compound'},
