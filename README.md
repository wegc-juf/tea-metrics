...
```bash
pip install https://wegenernet.org/downloads/teametrics/teametrics-0.13.2-py3-none-any.whl
```

For ICON/GRIB processing, install the optional `grib` dependencies:
```bash
pip install "teametrics[grib] @ https://wegenernet.org/downloads/teametrics/teametrics-0.13.2-py3-none-any.whl"
```
...
## Changelog
See the [v0.13.2 release notes](docs/releases/v0.13.2.md) for the latest bug fixes.
